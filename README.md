...
# **TRUSECURE INSURANCE BUSINESS PERFORMANCE DASHBOARD**
...
<img width="1904" height="895" alt="Insurance_Pipeline_1 (1)" src="https://github.com/user-attachments/assets/76992174-251a-4cf3-9ec1-e7da6839b845" />

* **Automated Schedule Orchestration:** To establish full hands-free execution, the pipeline is configured with a **Fixed Schedule Type** set to run **Daily** at an interval of **1 day**. This continuous automated run is bound by an active lifecycle timeline, starting on **21-05-2026** and automatically concluding on **21-05-2027**, while remaining strictly synchronized to the regional corporate time zone of `(UTC+05:30) Chennai, Kolkata, Mumbai`.
<img width="1185" height="849" alt="Insurance_RefreshSchedule" src="https://github.com/user-attachments/assets/08b9dbdd-1d33-4b47-9764-c708861b5b3f" />
